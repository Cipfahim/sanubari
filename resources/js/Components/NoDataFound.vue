<template>
    <div class="flex flex-col items-center justify-center mt-16" style="">
        <div class="flex flex-col items-center justify-center">
            <svg width="125" height="110" viewBox="0 0 125 110" fill="none"
                ...
                <g clip-path="url(#clip0)">
                    <path fill-rule="evenodd" clip-rule="evenodd"
                          ...
                          fill="#817AE3"></path>
                    <path fill-rule="evenodd" clip-rule="evenodd"
                          d="M60.4536 110H64.3539V72.6785H60.4536V110Z" fill="#55547A"></path>
                    <path fill-rule="evenodd" clip-rule="evenodd"
                    ...
                    <path fill-rule="evenodd" clip-rule="evenodd"
                          ...
                          fill="#817AE3"></path>
                    <path fill-rule="evenodd" clip-rule="evenodd"
                          d="M97.5059 110H99.456V72.6785H97.5059V110Z" fill="#55547A"></path>
                    <path fill-rule="evenodd" clip-rule="evenodd"
                          d="M25.3516 110H27.3017V72.6785H25.3516V110Z" fill="#55547A"></path>
                </g>
                <defs>
                    <clipPath id="clip0">
        ...
        <div class="mt-2">
            <label class="font-medium">No {{ resource }} found!</label>
        </div>
        <div class="mt-2">
            <label
                class="mt-1 text-base font-extralight text-gray-500 text-center flex"> This
                section
        ...
        <div class="mt-8">
            <inertia-link :href="actionLink"
                ...
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
                     width="24px" height="24px" class="w-6 h-6 mr-1 -ml-2">
