            ...
            <div>
              ...
              <div class="mt-4 sm:mt-3 space-y-6 sm:space-y-5">
                ...
                >
                  ...
                  >
                    EPF Employee Id<span class="text-blue-600"> *</span>
                  </label>
                ...
                >
                  <label
                    class="block text-sm font-medium text-gray-700 sm:mt-px sm:pt-2"
                  >
                    EPF Employee<span class="text-blue-600"> *</span> ( % )
                  </label>
                  <div class="mt-1 sm:mt-0 sm:col-span-2">
                    <div class="max-w-lg flex shadow-sm">
                      <input
                ...
                >
                  <label
                    class="block text-sm font-medium text-gray-700 sm:mt-px sm:pt-2"
                  >
                    EPF Employeer<span class="text-blue-600"> *</span> ( % )
                  </label>
                  <div class="mt-1 sm:mt-0 sm:col-span-2">
                    <div class="max-w-lg flex shadow-sm">
                      <input
                ...
                >
                  <label
                    class="block text-sm font-medium text-gray-700 sm:mt-px sm:pt-2"
                  >
                    SOCSO<span class="text-blue-600"> *</span>
                  </label>
                  <div class="mt-1 sm:mt-0 sm:col-span-2">
...
const steps = [
  ...
  { id: "C", name: "Contribution", href: "#", status: "current" },
