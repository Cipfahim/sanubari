<template>
    <app-layout>
        ...
        <div class="mt-4 px-4 sm:px-6 lg:px-8">
            <top-bar :employee="employee.id" :current="route('employees.bank-details.index', employee.id)"/>
...
export default {
    ...
    methods: {
        submit() {
            this.form.post(this.route('employees.bank-details.update', this.employee.id))
        },
