    ...
    <div class="mt-4 px-4 sm:px-6 lg:px-8">
      ...
      <div class="mb-6 flex justify-between items-center">
        ...
        <div class="flex justify-between">
          <inertia-link
            :href="route('honorarium-categories.create')"
      ...
      <div class="flex flex-col">
        <div class="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
          ...
          >
            <div
              v-if="honorariumCategories.data.length"
            ...
            >
              <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                  <tr
                    v-for="(category, index) in honorariumCategories.data"
                    :key="index"
                  >
                    <td
                    ...
                    >
                      <inertia-link
                        :href="route('honorarium-categories.edit', category.id)"
...
export default {
  ...
  methods: {
    ...
    destroy() {
      this.$inertia.delete(
        this.route("honorarium-categories.destroy", this.deleteCategory),
        {
          preserveState: true,
          preserveScroll: true,
          onSuccess: () => {
    ...
    bulkDestroy() {
      this.$inertia.post(
        this.route("honorarium-categories.bulk-destroy"),
        {
          _method: "DELETE",
