            ...
            <div class="overflow-hidden">
                <div class="w-full mb-5 sm:mb-5 bg-white rounded-md shadow">
                    <div class="w-full p-4 grid grid-cols-2 sm:grid-cols-5 gap-4">
                        ...
                        <div
                            class="col-span-1 rounded-md border border-gray-200 text-center group hover:shadow overflow-hidden transition duration-1000">
                            <inertia-link :href="route('settings.countries.index')"
                                          :class="[route().current('settings.countries.*') ? 'bg-cyan-400' : '']"
                                          class="group-hover:bg-cyan-400 flex items-center gap-2 sm:block p-3 sm:p-5">
                                <svg :class="[route().current('settings.countries.*') ? 'text-white' : 'text-gray-600']"
                                     class="h-7 w-7 sm:h-20 sm:w-20 sm:mx-auto group-hover:text-white"
                                     fill="currentColor"
                                ...
                                <p :class="[route().current('settings.countries.*') ? 'text-white' : 'text-cyan-500']"
                                   class="font-semibold text-center group-hover:text-white sm:mt-3">
                                    Country</p>
                            </inertia-link>
                        </div>
                        ...
                        <div
                            class="col-span-1 rounded-md border border-gray-200 text-center group hover:shadow overflow-hidden transition duration-1000">
                            <inertia-link :href="route('settings.cities.index')"
                                          :class="[route().current('settings.cities.*') ? 'bg-cyan-400' : '']"
                                          class="group-hover:bg-cyan-400 flex items-center gap-2 sm:block p-3 sm:p-5">
                                <svg :class="[route().current('settings.cities.*') ? 'text-white' : 'text-gray-600']"
                                     class="h-7 w-7 sm:h-20 sm:w-20 sm:mx-auto group-hover:text-white"
                                ...
                                <p :class="[route().current('settings.cities.*') ? 'text-white' : 'text-cyan-500']"
                                   class="font-semibold text-center group-hover:text-white sm:mt-3">
                                    City</p>
                            </inertia-link>
                        </div>
                        ...
                        <div
                            class="col-span-1 rounded-md border border-gray-200 text-center group hover:shadow overflow-hidden transition duration-1000">
                            <inertia-link :href="route('settings.banks.index')"
                                          :class="[route().current('settings.banks.*') ? 'bg-cyan-400' : '']"
                                          class="group-hover:bg-cyan-400 flex items-center gap-2 sm:block p-3 sm:p-5">
                                <svg :class="[route().current('settings.banks.*') ? 'text-white' : 'text-gray-600']"
                                     class="h-7 w-7 sm:h-20 sm:w-20 sm:mx-auto group-hover:text-white"
                                ...
                                <p :class="[route().current('settings.banks.*') ? 'text-white' : 'text-cyan-500']"
                                   class="font-semibold text-center group-hover:text-white sm:mt-3">
                                    Bank</p>
                            </inertia-link>
                        </div>
